...
Учебное CRM-приложение для салонов красоты. Проект реализован на React и позволяет вести клиентов, записи, сотрудников и отзывы, просматривать сводку и финансовые показатели.
